...
public class JmsConnector implements IncomingConnectorFactory {

    /**
     * The name of the connector: {@code lorislab-jms}
     */
    public static final String CONNECTOR_NAME = "lorislab-jms";
    ...
    private JMSContext createJmsContext(JmsConnectorIncomingConfiguration config) {
