...
@ConnectorAttribute(name = "transaction-group", description = "The transaction group for the JMS session", direction = Direction.INCOMING_AND_OUTGOING, type = "string")
...
public class JmsConnector implements IncomingConnectorFactory, OutgoingConnectorFactory {
     ...
     */
    public static final String CONNECTOR_NAME = "jms-stream";
    ...
    private final Map<String, JMSContext> transactionContexts = new HashMap<>();
    ...
    public PublisherBuilder<? extends Message<?>> getPublisherBuilder(Config config) {
        ...
        ic.getTransactionGroup().ifPresent(s -> transactionContexts.put(s, context));
    ...
    public SubscriberBuilder<? extends Message<?>, Void> getSubscriberBuilder(Config config) {
        ...
        Optional<String> tr = oc.getTransactionGroup();
        if (tr.isPresent()) {
            context = transactionContexts.get(tr.get());
        }
        if (context == null) {
            context = createJmsContext(oc);
        }
